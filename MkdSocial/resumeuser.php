...
<?php 
            $sql = mysqli_query($conn, "SELECT * FROM resume WHERE cv_member_id = {$user_id}");
            if(mysqli_num_rows($sql) > 0){
...
<div class="row">
    <div class="col-lg-4 col-xl-4">
        ...
        <div class="card-box">
            ...
            <?php
            $query = (mysqli_query($conn, "SELECT * FROM skills WHERE skills_member_id = {$user_id} "));
        ...
        <div class="card-box">
            <div class="tab-content">
                <div class="tab-pane show active" > <!-- EĞİTİM VE DENEYİM ALANI -->
                    ...
                    <?php
                    $query = (mysqli_query($conn, "SELECT * FROM work WHERE work_member_id = {$user_id} ORDER BY work_start "));
							while($row=mysqli_fetch_array($query)){
                    ...
                    <ul class="list-unstyled timeline-sm">
                    <?php
                    $query = (mysqli_query($conn, "SELECT * FROM education WHERE education_member_id = {$user_id} ORDER BY education_start "));
							while($row=mysqli_fetch_array($query)){
...
<?php }
									...
									{
									echo "<span style='display: flex;justify-content: center; COLOR:#212529;' ><b>".$row['fname']. " " . $row['lname']. " </b>&nbspHENÜZ BİR ÖZGEÇMİŞİNİ PAYLAŞMAMIŞTIR.</span>";
									}
							?>
